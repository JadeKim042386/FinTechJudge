...
class LoanRequestService(
    ...
    companion object {
        const val cssUrl = "http://locahost:8081/css/api/v1/request"
    }

    fun loanRequest(loanRequestDto: LoanRequestDto) {
        val reviewResult = loanRequestToDb(loanRequestDto)
        saveLoanReviewData(reviewResult.toLoanReviewEntity())
    }

    fun loanRequestToDb(loanRequestDto: LoanRequestDto): ReviewResponseDto {
